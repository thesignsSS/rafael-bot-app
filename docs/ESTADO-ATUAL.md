...
- As áreas `Proposta`, `Validação de Renda`, `Vendedor` e `Imóvel` reutilizam o mesmo componente de comentários, permitindo ao proprietário, convidados e administradores registrar mensagens identificadas por foto, nome, data e horário. Quando o histórico possui rolagem interna, a lista abre automaticamente no comentário mais recente.
